...
if( !is_admin() ) {
	...
	wp_enqueue_script( 'jason_js', get_template_directory_uri() . '/scripts/jason.js', array ( 'jquery' ), 2.0, true);

	wp_enqueue_style( 'main_style', get_template_directory_uri() . '/style.css', array ( ), 2.0);
